...
if not Path(SYMBOL_FILE).exists():
    print("make sure you have your compiler-result `symbols.txt` file")
    print(f"symlinked by '{SYMBOL_FILE}' ... something like:")
    print("`ln -s ../../runners/embedded/your-symbols-file.txt symbols.txt`")
    sys.exit(1)
