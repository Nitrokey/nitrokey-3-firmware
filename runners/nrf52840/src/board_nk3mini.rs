...
pub fn init_gpio(gpiote: &Gpiote, gpio_p0: p0::Parts, gpio_p1: p1::Parts) -> BoardGPIO {
	/* Button 1-4: on DK */
	let btn1 = gpio_p0.p0_04.into_pullup_input().degrade();
	...
	/* LEDs */
	let led_r = gpio_p0.p0_13.into_push_pull_output(Level::High).degrade();
	let led_g = gpio_p0.p0_14.into_push_pull_output(Level::High).degrade();
	let led_b = gpio_p0.p0_15.into_push_pull_output(Level::High).degrade();
	...
	BoardGPIO { buttons: [
			Some(btn1), None, None, None, None, None, None, None ],
