...
int main(int an, char **ac) {
	...
	fsmmap = mmap((void *)0xe0000, 0x20000, PROT_READ | PROT_WRITE, MAP_FIXED | MAP_SHARED | MAP_ANONYMOUS, -1, 0);
	if (fsmmap == MAP_FAILED) return 1;

	memset(fsmmap, 0xff, 0x20000);
